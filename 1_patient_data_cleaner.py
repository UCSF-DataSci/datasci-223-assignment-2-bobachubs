...
def clean_patient_data(patients):
    ...
    # FIX: just change 'name' and cast dict to df to make it easier to work with
    ...
    cleaned_patients = patients.to_dict(orient='records')
...
def main():
    ...
    if patients is None:
        print("Unable to load patient data.")
        return
